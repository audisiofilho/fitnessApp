...
export default function Profile() {
  ...
  return (
    <Container>
      ...
      <Name style={{fontFamily: 'Roboto-Bold'}}>{user?.name}</Name>
      <Email>{user?.email}</Email>

      <Button bg="#DE1414" onPress={() => setOpen(true)}>
        <ButtonText color="#fff" style={{fontFamily: 'Roboto-Bold'}}>Atualizar Perfil</ButtonText>
      </Button>
